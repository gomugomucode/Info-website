...
- `content/notes/security/black-hat-python-a-must-read-for-ethical-hackers-pentesters.mdx`: large_unsafe_removal
- `docs/+100 Linux Command (2).pdf`: unsafe_source_pdf_left_unchanged, spam_source_left_unchanged
- `docs/+100 Linux Command.pdf`: unsafe_source_pdf_left_unchanged, spam_source_left_unchanged
- `docs/100_Kali_Linux_Commands_Every_Ethical_Hacker_Must_Know_–_Part_3.pdf`: spam_source_left_unchanged
- `docs/100_Kali_Linux_Commands_Every_Ethical_Hacker_Must_Know–PART_1.pdf`: spam_source_left_unchanged
- `docs/100KaliLinuxCommandsEveryHackerMustKnowPart02.pdf`: spam_source_left_unchanged
- `docs/50 Kali Linux tools_MY.pdf_compressed.pdf`: unsafe_source_pdf_left_unchanged, spam_source_left_unchanged
- `docs/A-Z Kali Linux COMMAND.pdf`: spam_source_left_unchanged
- `docs/A–Z Kali Linux Commands.pdf`: spam_source_left_unchanged
- `docs/Basic Windows CMD for Pentesters.pdf`: spam_source_left_unchanged
- `docs/Black_Hat_Python_–_A_Must_Read_for_Ethical_Hackers_&_Pentesters_.pdf`: unsafe_source_pdf_left_unchanged
- `docs/Blue Team Notes.pdf`: unsafe_source_pdf_left_unchanged
- `docs/Blue Team Toolkit.pdf`: spam_source_left_unchanged
- `docs/Blue Team Toolkit.pdf.pdf`: spam_source_left_unchanged
- `docs/Bug Bounty Methodology 2026_compressed.pdf`: spam_source_left_unchanged
- `docs/Bug Bounty Playbook.pdf`: unsafe_source_pdf_left_unchanged
- `docs/Creatively Malicious Prompt Engineering.pdf`: unsafe_source_pdf_left_unchanged
- `docs/Essential Linux Commands for Cybersecurity Specialists.pdf.pdf`: unsafe_source_pdf_left_unchanged, spam_source_left_unchanged
- `docs/Firewall Security Commands.pdf`: spam_source_left_unchanged
- `docs/Hacking Drone with DroneSploit part1.pdf`: spam_source_left_unchanged
- `docs/Hacking Drone with DroneSploit part2.pdf`: spam_source_left_unchanged
- `docs/Kali Linux Cheat Sheet for Penetration Testers.pdf`: spam_source_left_unchanged
- `docs/KALI LINUX HACKING CHEAT SHEET20 Essential tools.pdf`: unsafe_source_pdf_left_unchanged, spam_source_left_unchanged
- `docs/Kali_Linux_REVELEALED.pdf`: unsafe_source_pdf_left_unchanged
- `docs/Linux and windows reverse shell scripts.pdf`: spam_source_left_unchanged
- `docs/Linux Commands Every Cybersecurity Specialist Needs.pdf.pdf.pdf`: spam_source_left_unchanged
- `docs/Master Termux Handbook (2).pdf`: spam_source_left_unchanged
- `docs/Master Termux Handbook.pdf`: spam_source_left_unchanged
- `docs/Metasploit for Beginners.pdf`: spam_source_left_unchanged
- `docs/NMAP COMMANDS CHEAT SHEET.pdf`: spam_source_left_unchanged
- `docs/Nuclei Plugin & Burp Suite – Template Creation Guide.pdf`: spam_source_left_unchanged
- `docs/OSCP CheatSheet.pdf`: unsafe_source_pdf_left_unchanged
- `docs/PowerShell Cheat Sheet Every Windows User Saves-compressed.pdf`: spam_source_left_unchanged
- `docs/Reverse Shells - Windows - HexSecCheatSheet (2).pdf`: unsafe_source_pdf_left_unchanged, spam_source_left_unchanged
- `docs/Reverse Shells - Windows - HexSecCheatSheet.pdf`: unsafe_source_pdf_left_unchanged, spam_source_left_unchanged
- `docs/sqlmap - SQL Injection attack.pdf`: spam_source_left_unchanged
- `docs/SqlMap Guide.pdf`: unsafe_source_pdf_left_unchanged
- `docs/Top 10 Mobile Penetration Testing Tools for Ethical Hackers.pdf`: spam_source_left_unchanged
- `docs/Top 20 FREE Cyber Security Tools You MUST Learn in 2026 (1).pdf`: spam_source_left_unchanged
- `docs/Top_10_Web_Vulnerability_Scanners_Every_Ethical_Hacker_Must_Know.pdf`: spam_source_left_unchanged
- `docs/Top_50_Kali_Linux_Tools_Guide_for_Offensive_Professionals_pdf_20250818.pdf`: spam_source_left_unchanged
- `docs/Web Security Basic To expert.pdf`: spam_source_left_unchanged
- `docs/Windows CLI 100 Commands Every Hacker Should Know_compressed.pdf`: spam_source_left_unchanged
- `docs/Windows Event Log Analysis - Advanced Threat Detection Guide.pdf`: unsafe_source_pdf_left_unchanged
- `docs/Wireless Penetration Testing_ Bettercap .pdf`: spam_source_left_unchanged
- `docs/WIRESHARK .pdf`: unsafe_source_pdf_left_unchanged
- `docs/📡 Wireshark.pdf`: unsafe_source_pdf_left_unchanged
