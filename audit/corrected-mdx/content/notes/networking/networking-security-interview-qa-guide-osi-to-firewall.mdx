...
### Q2: Which Layer is Responsible for Reliable Connection?

The transport layer guarantees a reliable end-to-end connection

### Q3: What are Different protocol works at each of the Layer in OSI model?
...
### Q5: What is the port number and give some example?
...
### Q6: What is the range of port Number?

Well known Ports – 0 to 1023
Registered Ports-1024 to 49151
Open Poerts-49152 to 65535

### Q7: What is a Protocol Number and give some examples?
...
### Q8: What is the Unicast, Multicast and Broadcast?
...
### Q9: What is the different between Half-duplex and Full duplex?
...
### Q13: What are the protocols that are include by each layer of the TCP/IP model?
...
### Q15: ARP work at Which layer and Why?
...
### Q16: What is an ARP Table(cache)?
...
### Q17: What is the size of an ARP request and ARP reply packet?

The size of an ARP request or reply packet is 28 bytes.

### Q18: What is  Proxy ARP?
...
### Q23: What is (Transmission Control Protocol) TCP?
...
### Q24: Explain TCP Three-Way handshake process?
...
### Q28: What is the importance of Sequence Number and Acknowledgement Number?
...
### Q32: How the packet is reassembled?
...
### Q33: What is the Importance of DF, FM Flag?
...
### Q34: What is the purpose of a fragment offset?

It is used to define  the size of each fragmentation packet.

### Q35: What is the important of TTL Value?
...
### Q40: What are the possible location of IOS Image?

- FLASH and TFTP Server.

### Q41: What are different modes in the router?
...
### Q42: What is the command to reboot a router?

- #reload

### Q43: What is the command to backup IOS to TFTP server?

- #copy flash tftp

### Q44: What is the command to copy running config to startup config?

- #copy running-config start-up-config

### Q45: Define static routing?
...
### Q48: What is the Routed protocol?
...
### Q49: What is the Routing Protocol?
...
### Q54: What is the Range of AD Values?
...
### Q57: What is Hybrid Routing Protocol?
...
### Q61: Define Bandwidth and Latency?
...
### Q64: Explain EIGRP Routing Protocol?
...
### Q65: What are the requirement Neighborship in EIGRP?
...
### Q66: What table do EIGRP routers maintain?
...
### Q70: Why no auto-summary command used in EIGRP?
...
### Q76: What is advertised Distance & Reported Distance?
...
### Q77: What authentication does EIGRP support?

EIGRP support only MD5 authentication.

### Q78: What is the Formula EIGRP used to Calculate Metric?

((10^7/least bandwidth of link) +cumulative delay) *256

### Q79: What is the Different Administrative Distance that EIGRP used?

- Internal-90
- Extranal-170
- Summary -5

### Q80: What is the EIGRP packet types?
...
### Q81: What is the EIGRP named mode?
...
### Q84: What is the EIGRP Convergence?
...
### Q85: How do I fix EIGRP stuck in active?
...
### Q87: What is the EIGRP stub router?
...
### Q88: What is split horizon in EIGRP?
...
### Q89: What multicast address does EIGRP used?

EIGRP router use the multicast address of 224.0.0.10

### Q90: How Configure EIGRP?
...
### Q91: How to configuration EIGRP named mode?
...
### Q92: Tell me some commands to troubleshoot EIGRP?
...
### Q93: What is the OSPF routing protocol?
...
### Q95: What is the Intra-area route?

Intra-area routes refer to updates that are passed within the area.

### Q96: What is an Area border router (ABR)?
...
### Q98: What is an Autonomous System Boundary Router ASBR?
...
### Q104: What is the passive interface?
...
### Q105: What are the Requirements of neighbor adjacency?
...
### Q106: How do I reset my OSPF neighbour?

Use the clear ip ospf neighbour command to clear neighbour

### Q107: What is Designated Router (DR)?
...
### Q108: What is Backup-Designated Router (BDR)?
...
### Q109: How OSPF DR and BDR are elected?
...
### Q110: What is the OSPF packet types?
...
### Q111: What is the OSPF neighbor states?
...
### Q113: What is the OSPF network types?
...
### Q114: What is the OSPF Authentication?
...
### Q115: What is the Router LSA (link-state advertisement)?
...
### Q118: What is the ASBR Summary LSA?
...
### Q119: What is the ASBR External LSA?
...
### Q120: What is the NSSA external LSA?
...
### Q121: What does the Table maintain by OSPF?
...
### Q122: Explain OSPF Virtual Link?
...
### Q123: Explain Stub Area and different types of Stub area?
...
### Q124: Can we have OSPF run over a GRE Tunnel?

Yes, we can have OSPF run over a GRE tunnel.

### Q125: How do we configure the OSPF Routing Protocol?
...
### Q126: Explain the Border Gateway Protocol (BGP)?
...
Protocol, Internal BGP (i BGP). In contrast, the Internet application of the protocol is
called Exterior Border Gateway Protocol, External BGP (e BGP).

### Q127: What are the BGP features?

- Path vector protocol
- Open standard protocol.
- Classless routing protocol.
- Used the Path vector algorithm.
- Administrative distance for e BGP is 20,i BGP-200
...
### Q128: Can Router on different subnet become BGP Neighbors?
...
### Q129: Different between e BGP & i BGP neighbors?
...
### Q130: Explain Loop prevention mechanism in BGP?

BGP used two mechanisms to prevent loops: -
- When a router learns route from an i BGP peer, that router does not advertise the
same routes to another i BGP peer.
- By using AS_PATH- When advertising to an e BGP peer, a BGP router adds its own
...
Note: - A BGP router does not add its ASN when advertising to an i BGP Peer.

### Q131: What is different between the hard reset and soft rest in BGP?
...
### Q132: What are different BGP Message Types?
...
### Q133: Explain various state of BGP?
...
### Q134: Explain BGP Path Attributes?
...
Preference is passed on to i BGP peers when sending updates. Local Preference
informs i BGP routers how to exit the AS if multiple paths exist. Local Preference is a
...
command) are better than i BGP/e BGP learned.
...
- Multi-Exit Discriminator (MED)- The MED (Multi Exit Discriminator) attribute is
...
### Q139: What is router reflector and why it is required?

In BGP, route learned from an i BGP neighbour will not be advertised to another i BGP
neighbour. To overcome this situation route reflector is used. It is acts as a route reflector
server and makes i BGP neighbours as route reflector client enabling route advertisements
between them.

### Q140: What is the command to administratively  disable BGP neighborship?

#neighbor-ip shutdown
# no neighbor-ip shutdown (to enable to again)

## Switching


### Q141: What is switching?

The function of switching is to switch data packets between devices on the same network.

### Q142: What is swi tching?
...
### Q143: What is the different between a HUB, Switch & Router?


### Q144: What are functions of the switch?
...
### Q146: What is a Broadcast Domain & Collision Domain?
...
### Q147: What is a MAC address table and how a switch will build a M AC table?
...
### Q148: How does switch learn Mac address?
...
### Q150: What is a VLAN and How does it reduce the broadcast traffic?
...
### Q151: What is the deference between an access port and a trunk port?
...
### Q152: What is Frame Tagging and Different types of Tagging?
...
### Q153: Explain the different between 802.1Q and ISL?
...
### Q154: What is a Native VLAN and What type of traffic will go through Native VLAN?
...
### Q155: What is Inter -VLAN Routing?
...
### Q163: What are different  VTP mode?
...
### Q164: What are requirement to exchange VTP message between two switches?
...
### Q165: Explain Dynamic Trucking Protocol (DTP)?
...
### Q166: Explain Dynamic desirable & Dynamic auto?
...
### Q167: What is STP and Redundant Links?
...
### Q169: What are the different port states?
...
### Q170: What is STP timer and  explain different types of STP timer?
...
### Q171: Explain types of STP Port Roles?
...
### Q173: What is the destination MAC address used by Bridge Protocol data Unit es (BPDUs)?

Bridge Protocol Data Units (BPDUs) frames are sent out as at multicast destination MAC
address 01:80:c2:00:00:00.

### Q174: How Root Bridge is elected?
...
### Q177: What information can a DHCP provide to Host?
...
### Q179: What is the range of APIPA address?
...
### Q180: What is the purpose of a relay agent?
...
### Q181: What is DHCP decline message?
...
### Q183: Which port are used in SNMP?
...
### Q186: At which layer IPsec works?

- IPsec secures IP traffic at the Layer-3 (Network Layer) of OSI model.

### Q187: Name a major drawback of IPsec?

- IPsec only supports unicast IP traffic.

### Q188: What is the different between Transport & Tunnel mode?
...
### Q189: What are the three main security services that IPsec VPN provide?
...
### Q191: What is Site to Site and Remote access VPN?
...
### Q192: What are the 3-protocol used in IPsec?

- Authentication Header (AH).
- Encapsulation Security test vector (ESP).
- Internet Key Exchange (IKE).

### Q193: How ESP & AH provide anti -replay protection?
...
### Q195: Which protocol does IKE use?

IKE uses UDP port 500.

### Q196: Explain how IKE/ISAKMP Works?
...
### Q197: Explain the message exchange between the peers in IKE/ISAKMP?
...
### Q199: What are Security Associations?
...
### Q201: What are Crypto access lists?
...
### Q206: Name a major drawback of b oth GRE & L2TP?

No encryption.

### Q207: What is SSL VPN? How it is different from IPsec VPN?
...
### Q209: What is the difference between Gateway and Firewall?
...
### Q210: At which Layers does Firewall work?

Firewall works at layer 3,4 & 7.

### Q211: What is the difference between Stateful & Stateless Firewall?
...
### Q212: What information does Stateful firewall maintain?
...
### Q218: What are the values for time out of the TCP session, UDP session, ICMP session?

TCP session- 60 mints
UDP session- 2 mints
ICMP session- 2 sec

### Q219: What is the differen ce in ACL on ASA than on Router?
...
### Q220: What are the different types of ACL in the Firewall?
...
### Q221: What is Transparent Firewall?
...
### Q222: What is the need for a Transparent Firewall?
...
### Q223: What are the different between a switch and ASA  (in transparent mode)?
...
### Q224: What information is exchanged between ASAs over a Failover link?
...
### Q225: Explain Active/Standby Failover?
