    ...
    <div className="container mx-auto max-w-3xl px-4 py-16 sm:py-24">
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <div className="flex gap-4 not-prose mt-6">
          ...
          <a href="https://github.com/anupambaral" target="_blank" rel="noopener noreferrer" className="inline-flex items-center rounded-md border border-neutral-200 bg-white px-4 py-2 text-sm font-medium text-neutral-900 shadow-sm hover:bg-neutral-50 dark:border-neutral-800 dark:bg-neutral-950 dark:text-neutral-50 dark:hover:bg-neutral-900 transition-colors">
